--[[
	Bagforge_WorldEvents - Database
	-------------------------------------------------------------------------
	Item ID lists for all supported world events.
--]]
...
Database.WoWRemixCache = {
	...
	245553, --Cache of Infinite Treasure
...
Database.WoWRemixArtifact = {
	...
	242516, --Memento of Epoch Legends
